        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light w-screen h-full flex items-center justify-between shadow-md px-4 py-5">
            ...
            <div id="RIGHT">
                <ul className="navbar-nav flex flex-row gap-x-4 pr-4 items-center">
                    <li className="nav-item gap-x-1 flex items-center">
                        <a className="nav-link bg-emerald-600 hover:bg-emerald-800 duration-300 text-white font-bold tracking-tight rounded px-4 py-1 text-xl" href="#">ورود</a>
