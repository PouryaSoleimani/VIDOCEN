...
const GridBoxComponent = () => {
    return (
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 grid-rows-4 md:grid-rows-4 gap-2 md:gap-2 m-4 text-center text-white font-bold text-xl md:text-3xl">
            ...
            <div className="GRID___1 col-start-3 row-start-1 md:col-start-3 md:row-start-1 md:col-span-1 md:row-span-1 bg-black font-bold rounded-md p-10 whitespace-nowrap flex items-center jus"><h2 className='mx-auto w-full text-center'>بی نهایت</h2> </div>
